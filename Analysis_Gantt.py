...
df = pd.DataFrame([
    ...
    dict(Task="Milestones", Start='2027-03-01', Finish='2027-06-30', Resource="Collab.", Label='Data reduction'),
    ...
    dict(Task="Map<br>Making", Start='2026-07-01', Finish='2027-03-30', Resource="M", Label='Dev. Mapmaker'),
    dict(Task="Map<br>Making", Start='2026-09-01', Finish='2026-09-30', Resource="M", Label='Namap<br>ready'),
    dict(Task="Map<br>Making", Start='2024-11-01', Finish='2024-11-30', Resource="M", Label='read<br>other<br>data<br>format'),
    dict(Task="Map<br>Making", Start='2024-12-01', Finish='2025-01-30', Resource="M", Label='Implement<br>freqs'),
    dict(Task="Map<br>Making", Start='2025-02-01', Finish='2025-02-28', Resource="M", Label='Discuss<br>in-flight<br>plots'),
    dict(Task="Map<br>Making", Start='2026-02-01', Finish='2026-02-28', Resource="M", Label='Lock-in<br>scan<br>patterns<br>&pointings'),
    dict(Task="Map<br>Making", Start='2027-8-01', Finish='2027-9-30', Resource="M", Label='1st<br>[CII]<br>maps'),
    dict(Task="Map<br>Making", Start='2027-10-01', Finish='2027-10-30', Resource="M", Label='Push Analysis button'),
    ...
    dict(Task="Pointed Obs.", Start='2026-07-01', Finish='2026-07-30', Resource="M,D", Label='Review+<br>&Publication'),
    ...
    dict(Task="Scan Strategy", Start='2026-03-01', Finish='2026-03-30', Resource="F", Label='Scan strat. on repo'),

    dict(Task="QA", Start='2026-03-01', Finish='2026-03-30', Resource="?", Label='Scan strat. on repo'),

    dict(Task="Masking", Start='2026-03-01', Finish='2026-03-30', Resource="?", Label='Scan strat. on repo'),

    dict(Task="Noise", Start='2026-03-01', Finish='2026-03-30', Resource="F,?", Label='Noise on repo'),

    dict(Task="In-flight plan ready", Start='2026-03-01', Finish='2026-03-30', Resource="E,F,M", Label='Plan in repo'),

    dict(Task="Auto-power", Start='2026-01-01', Finish='2026-03-30', Resource="R,J,S", Label='Pipeline on repo'),
    ...
    dict(Task="Null tests", Start='2025-06-01', Finish='2025-08-30', Resource="S", Label='1st round of null test'),
    ...
    dict(Task="Blind Detection", Start='2026-01-01', Finish='2026-03-30', Resource="?", Label='Pipeline on repo'),
